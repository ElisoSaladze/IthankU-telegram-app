...
export const NewSpaceDetails = () => {
  const navigate = useNavigate();
  const { control, setValue, watch, handleSubmit } = useCreateSpaceContext();
    ...
    <Stack width={1} textAlign="start" alignItems="center" justifyContent="center">
      ...
      <Stack mt={1} gap={1} width={1}>
        ...
        <VisibilityStatus
          name="privacy"
          control={control}
          labels={['Anyone can join this space', 'Only visible to those you share with']}
          isSpaceVisibility
        />
      </Stack>
      ...
      <Button
        ...
        onClick={handleSubmit(() => {
          navigate(paths.createSpaceInterests);
        })}
      >
        Next
      </Button>
