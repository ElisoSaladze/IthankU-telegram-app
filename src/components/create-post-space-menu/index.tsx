...
export const CreatePostSpaceMenu = ({ button, fromSpacePage }: Props) => {
  ...
  return (
    <>
      ...
      >
        ...
        />
        <MenuItem onClick={() => navigate(paths.createSpaceDetails)}>Create Space</MenuItem>
      </Menu>

      <CreatePostDialog
        isOpen={isPostsDialogOpen.isTrue}
        onClose={isPostsDialogOpen.setFalse}
        fromSpacePage={fromSpacePage}
      />
    </>
  );
};
